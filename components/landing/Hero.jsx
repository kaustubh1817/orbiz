...
export default function Hero() {
  ...
  return (
    <section className="pl-10 md:pl-18 2xl:pl-18 3xl:pl-22 relative py-10 md:py-0 3xl:py-0">
      <div className="flex flex-col md:flex-row w-full text-center md:text-left gap-10">
        ...
        <div className="relative flex flex-col w-full md:w-1/2 md:h-[625px] 3xl:h-[750px] h-[445px]">
          <img
            ...
            alt="top-box-image"
            className="absolute 3xl:top-12 md:top-10 top-0 right-52 3xl:right-98.5 md:right-82.5 md:mb-9 md:h-17 md:w-42 h-18 w-42"
          />
