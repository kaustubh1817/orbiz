...
export default function Navbar() {
    ...
    return (
        <nav className="w-full md:h-[94px] bg-[#F5F5F5] py-3 fixed z-[10000] left-1/2 -translate-x-1/2 flex justify-between rounded-[12px] md:rounded-none items-center container-padding ">
            <div>
